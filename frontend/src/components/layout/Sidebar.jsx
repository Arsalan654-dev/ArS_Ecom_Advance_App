  ...
  const SidebarBody = (
    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div>
              ...
              <div className="text-violet-200 text-xs mt-0.5">{user?.fullName || "Welcome"}</div>
            </div>
          )}
        </div>
        <button
      ...
      <div className="p-3 border-t border-white/10 shrink-0">
        <button onClick={handleSignOut} className={`${baseLink} ${inactive} w-full`} title="Sign out border">
